...
const getUrlForCoffeeStores = (latLong, query, limit) => {
    return `https://api.foursquare.com/v3/places/search?query=${query}&ll=${latLong}&limit=${limit}&open_now=true&radius=3000`
}
...
export const fetchCoffeeStore = async (latLong = `40.763999619539604,-73.9724186062827`, limit = 6, query) => {
